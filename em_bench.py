...
X = pd.read_csv('All_columns_not_normalized.csv')
...
plt.title('Excess-Mass curve for low dimensional data', fontsize=20)
...
plt.title('Mass-Volume Curve for low dimensional data', fontsize=20)
